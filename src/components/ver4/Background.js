...
import styles from "../../css/ver4/Background.module.css";
...
const Background = ({ mode }) => {
  return (
    <div className={`${styles.background} ${styles[mode]}`}>
      ...
      {mode === "idle" && (
        <>
          <img src="/images/ver4/gauge.png" alt="Top Gauge 1" className={styles.idleTopImage1} />
          <img src="/images/ver4/gauge.png" alt="Top Gauge 2" className={styles.idleTopImage2} />
      ...
      {mode === "complete" && (
        <>
          ...
          <img src="/images/ver4/gauge.png" alt="Gauge" className={styles.completeGaugeTop} />
          <img src="/images/ver4/gauge.png" alt="Gauge" className={styles.completeGaugeBottom} />
        </>
      )}
    </div>
  );
